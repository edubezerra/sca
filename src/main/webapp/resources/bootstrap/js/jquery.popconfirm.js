    ...
    popConfirm: function (options) {
      ...
      return this.each(function () {
        ...
        self.popover({
          ...
          content: options.content + '<p class="button-group" style="margin-top: 10px; text-align: center;"><button type="button" class="btn btn-small btn-default confirm-dialog-btn-abort">' + options.noBtn + '</button> <button type="button" class="btn btn-small btn-primary confirm-dialog-btn-confirm">' + options.yesBtn + '</button></p>'
        }).click(function (e) {
          if (last && last !== self) {
