                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                    	<sec:authorize access="hasRole('ROLE_ALUNO')">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">Aluno</a>
								<ul class="dropdown-menu">
									<li>
										<a href="${pageContext.request.contextPath}/avaliacaoTurma/avaliacaoTurmas">
											Avaliação de Professores </a></li>
									<li>
										<a href="${pageContext.request.contextPath}/registroAtividades/registroAtividades">
					...
					<!-- 						Isenção de Disciplinas </a></li> -->
                        ...
                        <sec:authorize access="hasRole('ROLE_PROFESSOR')">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">Professor</a>
								<ul class="dropdown-menu">
									<li><a
						...
						<sec:authorize access="hasRole('ROLE_COORDENADOR_CURSO')">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">Coordenador</a>
								<ul class="dropdown-menu">
									<li><a
									...
									<li><a
										href="${pageContext.request.contextPath}/pastaProfessor/dashboard">
											Pasta Virtual</a></li>
									<li><a href="${pageContext.request.contextPath}/monografias/">
										Monografias</a></li>
								</ul>
							</li>
						</sec:authorize>
						...
						<sec:authorize access="hasRole('ROLE_COORDENADOR_ATIVIDADES')">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">Atividades</a>
								<ul class="dropdown-menu">
									<li><a
