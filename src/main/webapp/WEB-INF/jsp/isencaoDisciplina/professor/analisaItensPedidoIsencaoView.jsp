					...
					<div class="well">
						<div class="dados-aluno">
							<p>
								...
								${item.disciplina.nome} - CH (hora-aula):
								${item.disciplina.cargaHoraria}
							</p>

							<p>
								<b>Nome da disciplina externa:</b>
								${item.descritorDisciplinaExterna}
							</p>

							<p>
								<b>Nota final obtida na disciplina externa:</b>
								${item.notaFinalDisciplinaExterna}
							</p>

							<p>
								<b>Carga horária obtida da disciplina externa:</b>
								${item.cargaHorariaDisciplinaExterna}
							</p>
						...
						<div id="${item.id}" class="status text-center">
							<c:choose>
								<c:when test="${item.situacao eq 'SUBMETIDO'}">
