...
<script type="text/javascript" src="${rootURL}resources/js/app.js"></script>
    ...
    <script>
    	var urlInclusao = "${rootUrl}rest/turma";
...
<body class="inclusao-disciplina">
    <div class="container">
        ...
        <div class="row">
            <form action="${rootUrl}inclusaoDisciplina/incluiSolicitacao" 
        ...
        <a class="btn btn-default" href="${rootUrl}inclusaoDisciplina/homeInclusao">
