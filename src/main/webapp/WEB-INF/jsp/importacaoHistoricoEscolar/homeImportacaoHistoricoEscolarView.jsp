...
<link href="/sca/resources/importadorHistorico/importadorHistorico.css" media="screen" rel="stylesheet" type="text/css" />
...
<body>
	...
	<div class="content">
		...
		<form id="formHistorico"
			...
			<input id="uploadFile" value="Nenhum arquivo selecionado..." disabled="disabled" class="uploadedFile"/>
			<div class="fileUpload btn btn-primary">
			    <span>Procurar...</span>
			    <input name="historicoFile" id="historicoFile" type="file" class="upload" />
			</div>
			
            <br/><br/>
			<button class="btn btn-lg btn-primary btn-block" type="submit">Importar	Histórico</button>
		</form>
	</div>
</body>
</html>