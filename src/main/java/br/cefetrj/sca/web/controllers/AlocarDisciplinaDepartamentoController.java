...
import br.cefetrj.sca.service.AlocarDisciplinaDepartamentoService;

@Controller
@RequestMapping("/alocacaoDisciplinaDepartamento")
public class AlocarDisciplinaDepartamentoController {

	@Autowired
	private AlocarDisciplinaDepartamentoService service;
