...
import br.cefetrj.sca.service.AlocarCoordenadorAtividadesService;

@Controller
@SessionAttributes("roles")
@RequestMapping("/coordenacaoAtividades")
public class AlocarCoordenadorAtividadeComplementarController {

	@Autowired
	AlocarCoordenadorAtividadesService service;
