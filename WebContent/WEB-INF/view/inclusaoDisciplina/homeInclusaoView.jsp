...
<body class="home-inclusao text-center">
	<div class="container">
		<div class="row">
			...
			<h4>Matricula: <c:out value="${requestScope.aluno.matricula}"></c:out></h4>
		</div>
						...
						<table class="table table-bordered text-center">
							...
							<c:forEach items="${listaSemestresLetivos}" var="semestreLetivo" >
								<tr>
						          ...
						          <td>
						          	<form action="${pageContext.request.contextPath}/inclusaoDisciplina/listarSolicitacoes" method="POST">
