...
<!DOCTYPE html>
<html data-ng-app="isencaoDisciplinas" data-ng-controller="isencaoController">
...
<body class="inclusao-disciplina">
    <div class="container">
        ...
        <div class="row">
            <form action="${pageContext.request.contextPath}/isencaoDisciplinas/incluiSolicitacao" 
                ...
                <hr/>
                <div class="row" id="isencoes-disciplinas" >
                	<ul>
                        <li id="disciplinas" data-ng-repeat="input in inputs2">
                            <div id="inputs2" class="col-md-4">
	                            <p><b>Código da Disciplina:</b></p>
	                            <input class="form-control input-lg" data-ng-model="disciplina" data-ng-change="changeDisciplina(this, $index)" 
	                            name="codigoDisciplina{{$index}}" type="text"  placeholder="Digite o código da disciplina..." required/>    
	                        </div>
	                        <div id="inputs2" class="col-md-7">
	                            <p><b>Nome da Disciplina:</b></p>
	                            <input type="text" class="form-control input-lg" value="{{nomesDisciplina[$index]}}" readonly required>
	                        </div>
	                        <div class="col-md-1">
	                           <a class="remove" data-ng-click="removeInput2($index)"><i class="fa fa-minus-circle fa-3x"></i></a> 
	                        </div> 
                        </li>
                    </ul>
                </div>
              	<div class="row">
              		<a data-ng-click="addInput2()" class="add"><i class="fa fa-plus-circle fa-3x"></i> <h4>Adicionar Disciplina</h4> </a>
              	</div>
                ...
                <label for="inputFile">Anexar documentos comprobatórios 
                ...
                <div class="row checkbox">
                    <label>
                        ...
                        <b>não garante o deferimento das isenções solicitadas</b> 
                        e de que posso verificar se cada isenção foi efetivada ou não por meio 
                         de consulta ao SECAD, após 10 dias úteis da realização deste requerimento.
                    </label>
                </div>
