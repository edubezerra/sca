...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/formulario.js"
	charset="utf-8"></script>
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/bootstrap.min.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/egresso.css" />
	...
	<form method="POST"
		...
		<div class="row">
			<div class="col-md-8 form">
				...
				<h4 style="margin-left: 350px; font-weight: bold;">Médio/Técnico</h4>
				<hr />
